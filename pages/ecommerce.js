        ...
        <>
            ...
            <div className="w-full lg:h-screen md:h-screen dark:bg-gray-900">
                <div className="w-screen h-[50vh] relative">
                    ...
                    <Image className="absolute z-1" style={{ objectFit: "cover" }} src={ecommerceImg} alt="" fill />
                ...
                <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
                    <div className="col-span-4">
                        ...
                        <p className="dark:text-white">
                            ...
                            sign in to start shopping. They can add items to their carts and then order them.
                            Payment is supporting by Stripe. There is also an admin panel for admin accounts.
                            Admins can create new users, update and delete them. They can also create new products,
                            update and delete them. There are also some graphs if the shop has made some orders.
                        </p>
                        <a href="https://github.com/Jeyrem75/MERN-Ecommerce-App" target="_blank" rel="noreferrer">
